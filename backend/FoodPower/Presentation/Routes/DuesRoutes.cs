...
public class DuesRoutes
{
    public const string GetMyDuesMethod = "GET";
    public const string GetMyDuesName = "foodpower.dues.my";
    public const string GetMyDuesTemplate = "/api/dues/my";

    public const string GetAllDuesMethod = "GET";
